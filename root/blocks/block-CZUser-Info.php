...
********************************************************************/
	...
	global $prefix, $db, $userinfo, $currentlang, $imagebase, $board_config, $cz_config, $section_sub_img, $section_online_mem;
	...
	{
	    global $prefix, $db, $user_prefix, $Default_Theme, $name, $userinfo, $board_config, $imagebase, $cz_config, $lang_userblock;	
		$i = 1;	
		$hidden = 0;
	...
	{
    	global $prefix, $db, $cz_config, $lang_userblock;	
	...
	{
		global $prefix, $db, $userinfo, $cz_config, $section_sub_img, $section_online_mem, $lang_userblock;
