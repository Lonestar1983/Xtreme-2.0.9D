...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline" align="center"> 
  <tr> 
     <th class="thHead left" align="left" height="28"><span class="cattitle"><?php echo isset($this->vars['GLOBAL_TITLE']) ? $this->vars['GLOBAL_TITLE'] : $this->lang('GLOBAL_TITLE'); ?></span></th> 
  </tr> 
  <tr> 
...
?>
  <tr onclick="CFIG_slideCat('<?php echo isset($catrow_item['CAT_ID']) ? $catrow_item['CAT_ID'] : ''; ?>', false);" style="cursor: pointer;"  title="<?php echo isset($catrow_item['CAT_DESC']) ? $catrow_item['CAT_DESC'] : ''; ?>"> 
    <td class="catLeft" colspan="3" height="28">&nbsp;&nbsp;<img name="icon_sign_<?php echo isset($catrow_item['CAT_ID']) ? $catrow_item['CAT_ID'] : ''; ?>" src="<?php echo isset($this->vars['SPACER']) ? $this->vars['SPACER'] : $this->lang('SPACER'); ?>" border="0" alt="" />&nbsp;&nbsp;<span class="cattitle"><a href="<?php echo isset($catrow_item['U_VIEWCAT']) ? $catrow_item['U_VIEWCAT'] : ''; ?>" onclick="return CFIG_slideCat('<?php echo isset($catrow_item['CAT_ID']) ? $catrow_item['CAT_ID'] : ''; ?>', true);" onfocus="this.blur();" class="cattitle"><?php echo isset($catrow_item['CAT_DESC']) ? $catrow_item['CAT_DESC'] : ''; ?></a></span></td>
...
?>
  ...
  <tr id="forum_<?php echo isset($catrow_item['CAT_ID']) ? $catrow_item['CAT_ID'] : ''; ?>_<?php echo isset($forumrow_item['FORUM_ID']) ? $forumrow_item['FORUM_ID'] : ''; ?>"> 
...
?><?php $this->_tpldata['DEFINE']['.']['HAS_SUB'] = 1; ?><?php if ($sub_item['NUM'] > 0) {  ?><br /> <?php } else { ?><span style="font-weight:bold; padding-left: 20px;" class="gensmall"><?php echo isset($this->vars['L_SUBFORUMS']) ? $this->vars['L_SUBFORUMS'] : $this->lang('L_SUBFORUMS'); ?>:</span><span class="genmed"><br /> <?php } ?><?php echo isset($sub_item['LAST_POST_SUB']) ? $sub_item['LAST_POST_SUB'] : ''; ?> <a href="<?php echo isset($sub_item['U_VIEWFORUM']) ? $sub_item['U_VIEWFORUM'] : ''; ?>" <?php if ($sub_item['UNREAD']) {  ?>class="topic-new"<?php } ?> <?php echo isset($sub_item['FORUM_COLOR']) ? $sub_item['FORUM_COLOR'] : ''; ?> title="<?php echo isset($sub_item['FORUM_DESC_HTML']) ? $sub_item['FORUM_DESC_HTML'] : ''; ?>"><?php echo isset($sub_item['FORUM_NAME']) ? $sub_item['FORUM_NAME'] : ''; ?></a><?php
...
?>
	<td class="row3" align="center" valign="middle" height="50"><span class="gensmall"><?php echo isset($forumrow_item['TOTAL_TOPICS']) ? $forumrow_item['TOTAL_TOPICS'] : ''; ?></span></td>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  <tr> 
    <th class="thHead left" align="left" colspan="2" height="28"><span class="cattitle"><a href="<?php echo isset($this->vars['U_VIEWONLINE']) ? $this->vars['U_VIEWONLINE'] : $this->lang('U_VIEWONLINE'); ?>" class="cattitle"><?php echo isset($this->vars['L_WHO_IS_ONLINE']) ? $this->vars['L_WHO_IS_ONLINE'] : $this->lang('L_WHO_IS_ONLINE'); ?></a></span></th>
  </tr>
  <tr> 
    <td class="row1" align="center" valign="middle" rowspan="3"><img src="themes/chromo/forums/images/whosonline.gif" alt="<?php echo isset($this->vars['L_WHO_IS_ONLINE']) ? $this->vars['L_WHO_IS_ONLINE'] : $this->lang('L_WHO_IS_ONLINE'); ?>" /></td>
...
?>
  <tr>
	<th class="thHead left" align="left" colspan="2" height="28"><span class="cattitle"><?php echo isset($this->vars['L_TODAYS_BIRTHDAYS']) ? $this->vars['L_TODAYS_BIRTHDAYS'] : $this->lang('L_TODAYS_BIRTHDAYS'); ?></span></th>
  </tr>
  <tr> 
	<td class="row1" colspan="2"><table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td align="center" valign="middle" style="padding-right: 3px"><img src="modules/Forums/templates/subSilver/images/icon_birthday.gif" alt="<?php echo isset($this->vars['L_VIEW_BIRTHDAYS']) ? $this->vars['L_VIEW_BIRTHDAYS'] : $this->lang('L_VIEW_BIRTHDAYS'); ?>" /></td>
...
<input type="hidden" name="op" value="login" />
  <table align="center" width="54%" cellpadding="3" cellspacing="1" border="0" class="forumline">
    <tr> 
      <th align="left" class="thHead" height="28"><a name="login"></a><span class="cattitle2"><?php echo isset($this->vars['L_LOGIN_LOGOUT']) ? $this->vars['L_LOGIN_LOGOUT'] : $this->lang('L_LOGIN_LOGOUT'); ?></span></th>
    </tr>
    <tr> 
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
    <td width="20" align="center"><img src="themes/chromo/forums/images/folder_new.gif" alt="<?php echo isset($this->vars['L_NEW_POSTS']) ? $this->vars['L_NEW_POSTS'] : $this->lang('L_NEW_POSTS'); ?>"/></td>
    <td><span class="gensmall"><?php echo isset($this->vars['L_NEW_POSTS']) ? $this->vars['L_NEW_POSTS'] : $this->lang('L_NEW_POSTS'); ?></span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/chromo/forums/images/folder.gif" alt="<?php echo isset($this->vars['L_NO_NEW_POSTS']) ? $this->vars['L_NO_NEW_POSTS'] : $this->lang('L_NO_NEW_POSTS'); ?>" /></td>
    <td><span class="gensmall"><?php echo isset($this->vars['L_NO_NEW_POSTS']) ? $this->vars['L_NO_NEW_POSTS'] : $this->lang('L_NO_NEW_POSTS'); ?></span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/chromo/forums/images/folder_lock.gif" alt="<?php echo isset($this->vars['L_FORUM_LOCKED']) ? $this->vars['L_FORUM_LOCKED'] : $this->lang('L_FORUM_LOCKED'); ?>" /></td>
