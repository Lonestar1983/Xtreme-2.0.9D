...
?><table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    <tr <?php echo isset($this->vars['DHTML_HAND']) ? $this->vars['DHTML_HAND'] : $this->lang('DHTML_HAND'); ?> <?php echo isset($this->vars['DHTML_ONCLICK']) ? $this->vars['DHTML_ONCLICK'] : $this->lang('DHTML_ONCLICK'); ?>"show(<?php echo isset($this->vars['DHTML_ID']) ? $this->vars['DHTML_ID'] : $this->lang('DHTML_ID'); ?>)">
        <th  height="25" class="menu" colspan="2"><?php echo isset($this->vars['L_GENERAL_SETTINGS']) ? $this->vars['L_GENERAL_SETTINGS'] : $this->lang('L_GENERAL_SETTINGS'); ?></th>
    </tr>
</table>
...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    ...
    <tr> 
      <td class="row1"><?php echo isset($this->vars['L_GLOBAL_TITLE']) ? $this->vars['L_GLOBAL_TITLE'] : $this->lang('L_GLOBAL_TITLE'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_GLOBAL_TITLE_EXPLAIN']) ? $this->vars['L_GLOBAL_TITLE_EXPLAIN'] : $this->lang('L_GLOBAL_TITLE_EXPLAIN'); ?></span></td> 
      <td class="row2"><input class="post" type="text" maxlength="55" size="40" name="global_title" value="<?php echo isset($this->vars['GLOBAL_TITLE']) ? $this->vars['GLOBAL_TITLE'] : $this->lang('GLOBAL_TITLE'); ?>" /></td> 
    </tr> 
    <tr> 
      <td class="row1"><?php echo isset($this->vars['L_GLOBAL']) ? $this->vars['L_GLOBAL'] : $this->lang('L_GLOBAL'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_GLOBAL_EXPLAIN']) ? $this->vars['L_GLOBAL_EXPLAIN'] : $this->lang('L_GLOBAL_EXPLAIN'); ?></span></td> 
      <td class="row2"><textarea name="global_announcement" rows="5" cols="30" maxlength="255" onkeydown="return ismaxlength(this)"><?php echo isset($this->vars['GLOBAL_ANNOUNCEMENT']) ? $this->vars['GLOBAL_ANNOUNCEMENT'] : $this->lang('GLOBAL_ANNOUNCEMENT'); ?></textarea></td> 
    </tr> 
    <tr> 
      <td class="row1"><?php echo isset($this->vars['L_ENABLE_GLOBAL']) ? $this->vars['L_ENABLE_GLOBAL'] : $this->lang('L_ENABLE_GLOBAL'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_ENABLE_GLOBAL_EXPLAIN']) ? $this->vars['L_ENABLE_GLOBAL_EXPLAIN'] : $this->lang('L_ENABLE_GLOBAL_EXPLAIN'); ?></span></td> 
      <td class="row2"><input type="radio" name="global_enable" value="1" <?php echo isset($this->vars['S_ENABLE_GLOBAL_YES']) ? $this->vars['S_ENABLE_GLOBAL_YES'] : $this->lang('S_ENABLE_GLOBAL_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?>&nbsp;&nbsp;<input type="radio" name="global_enable" value="0" <?php echo isset($this->vars['S_ENABLE_GLOBAL_NO']) ? $this->vars['S_ENABLE_GLOBAL_NO'] : $this->lang('S_ENABLE_GLOBAL_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td> 
    </tr> 
    <tr> 
      <td class="row1"><?php echo isset($this->vars['L_DISABLE_MARQUEE']) ? $this->vars['L_DISABLE_MARQUEE'] : $this->lang('L_DISABLE_MARQUEE'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_DISABLE_MARQUEE_EXPLAIN']) ? $this->vars['L_DISABLE_MARQUEE_EXPLAIN'] : $this->lang('L_DISABLE_MARQUEE_EXPLAIN'); ?></span></td> 
      <td class="row2"><input type="radio" name="marquee_disable" value="1" <?php echo isset($this->vars['S_DISABLE_MARQUEE_YES']) ? $this->vars['S_DISABLE_MARQUEE_YES'] : $this->lang('S_DISABLE_MARQUEE_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?>&nbsp;&nbsp;<input type="radio" name="marquee_disable" value="0" <?php echo isset($this->vars['S_DISABLE_MARQUEE_NO']) ? $this->vars['S_DISABLE_MARQUEE_NO'] : $this->lang('S_DISABLE_MARQUEE_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td> 
    </tr> 
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_DHTML']) ? $this->vars['L_DHTML'] : $this->lang('L_DHTML'); ?></td>
        <td class="row2"><input type="radio" name="use_dhtml" value="1" <?php echo isset($this->vars['DHTML_YES']) ? $this->vars['DHTML_YES'] : $this->lang('DHTML_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="use_dhtml" value="0" <?php echo isset($this->vars['DHTML_NO']) ? $this->vars['DHTML_NO'] : $this->lang('DHTML_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_ADMIN_STYLE']) ? $this->vars['L_ADMIN_STYLE'] : $this->lang('L_ADMIN_STYLE'); ?></td>
        <td class="row2"><input type="radio" name="use_theme_style" value="1" <?php echo isset($this->vars['ADMIN_STYLE_THEME']) ? $this->vars['ADMIN_STYLE_THEME'] : $this->lang('ADMIN_STYLE_THEME'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="use_theme_style" value="0" <?php echo isset($this->vars['ADMIN_STYLE_DEFAULT']) ? $this->vars['ADMIN_STYLE_DEFAULT'] : $this->lang('ADMIN_STYLE_DEFAULT'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_DISABLE_BOARD_ADMINVIEW']) ? $this->vars['L_DISABLE_BOARD_ADMINVIEW'] : $this->lang('L_DISABLE_BOARD_ADMINVIEW'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_DISABLE_BOARD_ADMINVIEW_EXPLAIN']) ? $this->vars['L_DISABLE_BOARD_ADMINVIEW_EXPLAIN'] : $this->lang('L_DISABLE_BOARD_ADMINVIEW_EXPLAIN'); ?></span></td>
        <td class="row2"><input type="radio" name="board_disable_adminview" value="1" <?php echo isset($this->vars['S_DISABLE_BOARD_ADMINVIEW_YES']) ? $this->vars['S_DISABLE_BOARD_ADMINVIEW_YES'] : $this->lang('S_DISABLE_BOARD_ADMINVIEW_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?>  <input type="radio" name="board_disable_adminview" value="0" <?php echo isset($this->vars['S_DISABLE_BOARD_ADMINVIEW_NO']) ? $this->vars['S_DISABLE_BOARD_ADMINVIEW_NO'] : $this->lang('S_DISABLE_BOARD_ADMINVIEW_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_DISABLE_BOARD_MSG']) ? $this->vars['L_DISABLE_BOARD_MSG'] : $this->lang('L_DISABLE_BOARD_MSG'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_DISABLE_BOARD_MSG_EXPLAIN']) ? $this->vars['L_DISABLE_BOARD_MSG_EXPLAIN'] : $this->lang('L_DISABLE_BOARD_MSG_EXPLAIN'); ?></span></td>
        <td class="row2"><input class="post" type="text" maxlength="255" size="40" name="board_disable_msg" value="<?php echo isset($this->vars['DISABLE_BOARD_MSG']) ? $this->vars['DISABLE_BOARD_MSG'] : $this->lang('DISABLE_BOARD_MSG'); ?>" /></td>
    </tr>
   ...
   <tr>
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_MAX_SMILIES']) ? $this->vars['L_MAX_SMILIES'] : $this->lang('L_MAX_SMILIES'); ?></td>
        <td class="row2"><input class="post" type="text" name="max_smilies" size="3" maxlength="4" value="<?php echo isset($this->vars['MAX_SMILIES']) ? $this->vars['MAX_SMILIES'] : $this->lang('MAX_SMILIES'); ?>" /></td>
    </tr>
    <tr>
    ...
    <!-- Quick Search -->
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_QUICK_SEARCH_ENABLE']) ? $this->vars['L_QUICK_SEARCH_ENABLE'] : $this->lang('L_QUICK_SEARCH_ENABLE'); ?><br /><span class="gensmall"><?php echo isset($this->vars['L_QUICK_SEARCH_ENABLE_EXPLAIN']) ? $this->vars['L_QUICK_SEARCH_ENABLE_EXPLAIN'] : $this->lang('L_QUICK_SEARCH_ENABLE_EXPLAIN'); ?></span></td>
        <td class="row2"><input type="radio" name="quick_search_enable" value="1" <?php echo isset($this->vars['S_QUICK_SEARCH_ENABLE_YES']) ? $this->vars['S_QUICK_SEARCH_ENABLE_YES'] : $this->lang('S_QUICK_SEARCH_ENABLE_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="quick_search_enable" value="0" <?php echo isset($this->vars['S_QUICK_SEARCH_ENABLE_NO']) ? $this->vars['S_QUICK_SEARCH_ENABLE_NO'] : $this->lang('S_QUICK_SEARCH_ENABLE_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="row2" nowrap="nowrap">
            ...
            <input type="radio" name="default_time_mode" value="6" <?php echo isset($this->vars['TIME_MODE_FULL_PC_CHECKED']) ? $this->vars['TIME_MODE_FULL_PC_CHECKED'] : $this->lang('TIME_MODE_FULL_PC_CHECKED'); ?>/>
            ...
            <input type="radio" name="default_time_mode" value="4" <?php echo isset($this->vars['TIME_MODE_SERVER_PC_CHECKED']) ? $this->vars['TIME_MODE_SERVER_PC_CHECKED'] : $this->lang('TIME_MODE_SERVER_PC_CHECKED'); ?>/>
            ...
            <input type="radio" name="default_time_mode" value="3" <?php echo isset($this->vars['TIME_MODE_FULL_SERVER_CHECKED']) ? $this->vars['TIME_MODE_FULL_SERVER_CHECKED'] : $this->lang('TIME_MODE_FULL_SERVER_CHECKED'); ?>/>
            ...
            <span class="gen"> <?php echo isset($this->vars['L_TIME_MODE_DST']) ? $this->vars['L_TIME_MODE_DST'] : $this->lang('L_TIME_MODE_DST'); ?>:</span><input type="radio" name="default_time_mode" value="1" <?php echo isset($this->vars['TIME_MODE_MANUAL_DST_CHECKED']) ? $this->vars['TIME_MODE_MANUAL_DST_CHECKED'] : $this->lang('TIME_MODE_MANUAL_DST_CHECKED'); ?>/><span class="gen"><?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?></span>&nbsp;<input type="radio" name="default_time_mode" value="0" <?php echo isset($this->vars['TIME_MODE_MANUAL_CHECKED']) ? $this->vars['TIME_MODE_MANUAL_CHECKED'] : $this->lang('TIME_MODE_MANUAL_CHECKED'); ?>/><span class="gen"><?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></span>&nbsp;<input type="radio" name="default_time_mode" value="2" <?php echo isset($this->vars['TIME_MODE_SERVER_SWITCH_CHECKED']) ? $this->vars['TIME_MODE_SERVER_SWITCH_CHECKED'] : $this->lang('TIME_MODE_SERVER_SWITCH_CHECKED'); ?>/><span class="gen"><?php echo isset($this->vars['L_TIME_MODE_DST_SERVER']) ? $this->vars['L_TIME_MODE_DST_SERVER'] : $this->lang('L_TIME_MODE_DST_SERVER'); ?></span><br />
            <span class="gen"> <?php echo isset($this->vars['L_TIME_MODE_DST_TIME_LAG']) ? $this->vars['L_TIME_MODE_DST_TIME_LAG'] : $this->lang('L_TIME_MODE_DST_TIME_LAG'); ?>: </span><input type="text" name="default_dst_time_lag" value="<?php echo isset($this->vars['DST_TIME_LAG']) ? $this->vars['DST_TIME_LAG'] : $this->lang('DST_TIME_LAG'); ?>" maxlength="3" size="3" class="post" /><span class="gen"><?php echo isset($this->vars['L_TIME_MODE_DST_MN']) ? $this->vars['L_TIME_MODE_DST_MN'] : $this->lang('L_TIME_MODE_DST_MN'); ?></span><br />
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_ONLINE_TIME']) ? $this->vars['L_ONLINE_TIME'] : $this->lang('L_ONLINE_TIME'); ?> <br /><span class="gensmall"><?php echo isset($this->vars['L_ONLINE_TIME_EXPLAIN']) ? $this->vars['L_ONLINE_TIME_EXPLAIN'] : $this->lang('L_ONLINE_TIME_EXPLAIN'); ?></span></td>
        <td class="row2"><input class="post" type="text" size="3" maxlength="4" name="online_time" value="<?php echo isset($this->vars['ONLINE_TIME']) ? $this->vars['ONLINE_TIME'] : $this->lang('ONLINE_TIME'); ?>" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="row1"><?php echo isset($this->vars['L_REPORT_EMAIL']) ? $this->vars['L_REPORT_EMAIL'] : $this->lang('L_REPORT_EMAIL'); ?></td>
        <td class="row2"><input type="radio" name="report_email" value="1" <?php echo isset($this->vars['REPORT_EMAIL_YES']) ? $this->vars['REPORT_EMAIL_YES'] : $this->lang('REPORT_EMAIL_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="report_email" value="0" <?php echo isset($this->vars['REPORT_EMAIL_NO']) ? $this->vars['REPORT_EMAIL_NO'] : $this->lang('REPORT_EMAIL_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
    </tr>
    <tr>
