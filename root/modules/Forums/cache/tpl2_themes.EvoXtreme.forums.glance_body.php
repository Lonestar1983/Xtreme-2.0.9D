...
?>
    <tr>
        ...
        <th class="thTop" width="100" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_FORUM']) ? $this->vars['L_FORUM'] : $this->lang('L_FORUM'); ?>&nbsp;</th>
        <th class="thTop" width="100" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_AUTHOR']) ? $this->vars['L_AUTHOR'] : $this->lang('L_AUTHOR'); ?>&nbsp;</th>
        <th class="thTop" width="50" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_REPLIES']) ? $this->vars['L_REPLIES'] : $this->lang('L_REPLIES'); ?>&nbsp;</th>
        <th class="thCornerR" width="180" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_LASTPOST']) ? $this->vars['L_LASTPOST'] : $this->lang('L_LASTPOST'); ?>&nbsp;</th>
    </tr>
...
?>
    <tr>
        ...
        <td nowrap="nowrap" valign="middle" class="row1" align="center"><?php echo isset($news_item['ICON']) ? $news_item['ICON'] : ''; ?></td>
        <td valign="middle" class="row1" onmouseover="this.style.backgroundColor='#cccccc'" onmouseout="this.style.backgroundColor='#e0e0e0'"><span class="genmed"><a href="<?php echo isset($news_item['TOPIC_LINK']) ? $news_item['TOPIC_LINK'] : ''; ?>" class="genmed"><?php echo isset($news_item['TOPIC_TITLE']) ? $news_item['TOPIC_TITLE'] : ''; ?></a></span></td>
...
?>
    <tr>
        ...
        <th class="thTop" width="100" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_AUTHOR']) ? $this->vars['L_AUTHOR'] : $this->lang('L_AUTHOR'); ?>&nbsp;</th>
        <th class="thTop" width="50" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_REPLIES']) ? $this->vars['L_REPLIES'] : $this->lang('L_REPLIES'); ?>&nbsp;</th>
        <th class="thCornerR" width="120" align="center" nowrap="nowrap">&nbsp;<?php echo isset($this->vars['L_LASTPOST']) ? $this->vars['L_LASTPOST'] : $this->lang('L_LASTPOST'); ?>&nbsp;</th>
    </tr>
...
?>
    <tr>
        ...
        <td nowrap="nowrap" valign="middle" class="row1" align="center"><?php echo isset($recent_item['ICON']) ? $recent_item['ICON'] : ''; ?></td>
        <td valign="middle" class="row1" onmouseover="this.style.backgroundColor='#cccccc'" onmouseout="this.style.backgroundColor='#e0e0e0'"><span class="genmed"><a href="<?php echo isset($recent_item['TOPIC_LINK']) ? $recent_item['TOPIC_LINK'] : ''; ?>" class="genmed"><?php echo isset($recent_item['TOPIC_TITLE']) ? $recent_item['TOPIC_TITLE'] : ''; ?></a></span></td>
