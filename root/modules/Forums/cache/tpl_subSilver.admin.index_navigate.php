...
// eXtreme Styles mod cache. Generated on Fri, 25 Feb 2011 10:17:17 +0000 (time=1298629037)
  ...
  <tr>
    <td align="center" >
      <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
        <tr>
          <th height="25" class="thHead"><strong><?php echo isset($this->vars['L_ADMIN']) ? $this->vars['L_ADMIN'] : $this->lang('L_ADMIN'); ?></strong></th>
        </tr>
        <tr>
          <td class="row1"><span class="genmed"><a href="<?php echo isset($this->vars['U_HOME_NUKE']) ? $this->vars['U_HOME_NUKE'] : $this->lang('U_HOME_NUKE'); ?>" target="_parent" class="genmed"><?php echo isset($this->vars['L_HOME_NUKE']) ? $this->vars['L_HOME_NUKE'] : $this->lang('L_HOME_NUKE'); ?></a></span></td>
        </tr>
        <tr>
          <td class="row1"><span class="genmed"><a href="<?php echo isset($this->vars['U_ADMIN_NUKE']) ? $this->vars['U_ADMIN_NUKE'] : $this->lang('U_ADMIN_NUKE'); ?>" target="_parent" class="genmed"><?php echo isset($this->vars['L_ADMIN_NUKE']) ? $this->vars['L_ADMIN_NUKE'] : $this->lang('L_ADMIN_NUKE'); ?></a></span></td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="row1"><span class="genmed"><a href="../../../<?php echo isset($this->vars['U_FORUM_PREINDEX']) ? $this->vars['U_FORUM_PREINDEX'] : $this->lang('U_FORUM_PREINDEX'); ?>" target="main" class="genmed"><?php echo isset($this->vars['L_PREVIEW_FORUM']) ? $this->vars['L_PREVIEW_FORUM'] : $this->lang('L_PREVIEW_FORUM'); ?></a></span></td>
        </tr>
        <?php
...
?>
        <tr>
          <td height="28" class="catSides" style="cursor:pointer;cursor:hand;" onclick="onMenuCatClick('<?php echo isset($catrow_item['MENU_CAT_ID']) ? $catrow_item['MENU_CAT_ID'] : ''; ?>');"><span class="cattitle"><?php echo isset($catrow_item['ADMIN_CATEGORY']) ? $catrow_item['ADMIN_CATEGORY'] : ''; ?></span></td>
        </tr>
        <tr> 
            <td class="row1">
...
?>
        <tr>
          <td class="row1"><div id="menuCat_<?php echo isset($catrow_item['MENU_CAT_ID']) ? $catrow_item['MENU_CAT_ID'] : ''; ?>_<?php echo isset($modulerow_item['ROW_COUNT']) ? $modulerow_item['ROW_COUNT'] : ''; ?>" style="display:block;" class="genmed"><a href="<?php echo isset($modulerow_item['U_ADMIN_MODULE']) ? $modulerow_item['U_ADMIN_MODULE'] : ''; ?>"  target="main" class="genmed"><?php echo isset($modulerow_item['ADMIN_MODULE']) ? $modulerow_item['ADMIN_MODULE'] : ''; ?></a></div>
          </td>
        </tr>
        <?php
